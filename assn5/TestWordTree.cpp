...
//     EXPECT_NE(end(predictions), std::find(begin(predictions),
//     end(predictions), "acknowledges")); EXPECT_NE(end(predictions),
//     std::find(begin(predictions), end(predictions), "acknowledging"));
//     EXPECT_NE(end(predictions), std::find(begin(predictions),
//     end(predictions), "acorn")); EXPECT_NE(end(predictions),
//     std::find(begin(predictions), end(predictions), "acorns"));
//     EXPECT_NE(end(predictions), std::find(begin(predictions),
//     end(predictions), "acoustic"));
// }
